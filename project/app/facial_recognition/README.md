...
Implementation roadmap and verified baseline:
[Step-by-step plan](docs/implementation-plan.md).
The current 128-D recognizer uses handcrafted landmark/texture descriptors;
learned recognition embeddings and secure face-login validation remain planned.
