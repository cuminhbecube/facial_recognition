...
# Kernel defconfig
export RK_KERNEL_DEFCONFIG=rv1103_lbc_defconfig

# Kernel dts
export RK_KERNEL_DTS=rv1103g-lubancat-ipc.dts

# buildroot defconfig
export RK_BUILDROOT_DEFCONFIG=rv1103_lbc_defconfig
...
export RK_CAMERA_SENSOR_IQFILES="sc4336_OT01_40IRC_F16.bin sc431hai_CMK-OT2115-PC1_30IRC-F16.bin"

# Config sensor lens CAC calibrattion bin files
export RK_CAMERA_SENSOR_CAC_BIN="CAC_sc4336_OT01_40IRC_F16"

# Config CMA size in environment
export RK_BOOTARGS_CMA_SIZE="25M"
...
export RK_PARTITION_CMD_IN_ENV="256K(env),1M@256K(idblock),1M(uboot),4M(boot),180M(rootfs),38M(oem),10M(userdata)"
...
# enable xy step motor driver
export RK_ENABLE_MOTOR=y

# enable gb28181-sip
export RK_GB28181_SIP=y

# enable 4gnet init
export RK_ENABLE_4GNET=y
